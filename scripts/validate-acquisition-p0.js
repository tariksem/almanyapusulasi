...
const home=read('index.html'),priority=read('sitemap-priority.xml'),commercial=read('sitemap-commercial.xml'),finance=read('sitemap-finance-housing.xml'),indexnow=read('.github/workflows/indexnow.yml');
