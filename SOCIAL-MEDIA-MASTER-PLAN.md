...
Social media is a distribution and revenue channel, not a vanity-metric project.
...
Traffic potential × commercial intent × site fit determines production order.

P0/P1 social destinations:
- Brutto-Netto calculator
- Kfz comparison/switching
- Girokonto comparison
- Internet/DSL comparison
- Strom comparison
- Germany→Turkey money transfer
- Blue Card checker
...
No link dumping or promotional spam. Answer an actual user problem first. Link to Almanya Pusulası only when the relevant calculator/guide materially helps answer the question and group rules allow it.
...
1. First 1,000 social-origin site visits.
2. First 100 social-origin commercial-intent visits.
